                        ...
                        <div class="tab-pane fade in active" id="bulletin">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-append">
                                                <%--onblur="verify(this);"--%>
                                                <input class="span2 form-control" placeholder="请输入收到的验证码" type="text" id="code_sms" name="code_sms" onblur="verify(this);" style=" width: 50%; display: inline-block;">
                            ...
                            <div>
                                <div class="alert alert-success">
                                    当前只有测试手机可以注册,如果你想注册请去<a href="http://47.98.50.21:8081/u/reg">之前版本</a>注册，或者
                                    <a href="tencent://message/?uin=137416943&Site=在线咨询&Menu=yes">联系我</a>。注册之后可以来这里登录，也可以使用之前版本登录。<br>
                                    注：这是两个完全隔离的版本
                                </div>
                            </div>
                        </div>
